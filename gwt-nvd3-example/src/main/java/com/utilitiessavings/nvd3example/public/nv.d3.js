...
nv.models.axis = function() {
    ...
    var scale0;
    var renderWatch = new nv.utils.renderWatch(dispatch, duration);
...
nv.models.cumulativeLineChart = function() {
    ...
    var dx = d3.scale.linear()
        , index = {i: 0, x: 0}
        , renderWatch = new nv.utils.renderWatch(dispatch, duration)
        , currentYDomain
        ;
...
nv.models.forceDirectedGraph = function() {
    ...
    var renderWatch = new nv.utils.renderWatch(dispatch);
...
nv.models.historicalBar = function() {
    ...
    var renderWatch = new nv.utils.renderWatch(dispatch, 0);
